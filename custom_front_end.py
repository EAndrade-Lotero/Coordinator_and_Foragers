...
class TweakingOverheadControl(Control):
    ...
    def __init__(
        ...
        super().__init__()
        if 1 <= investment <= COORDINATOR_INITIAL_ENDOWMENT:
            self.remaining_investment = COORDINATOR_INITIAL_ENDOWMENT - investment
        else:
            self.remaining_investment = COORDINATOR_INITIAL_ENDOWMENT - int(investment * COORDINATOR_INITIAL_ENDOWMENT)
...
class InvestmentControl(Control):
    ...
    def __init__(self, map_path:str) -> None:
        ...
        self.endowment = COORDINATOR_INITIAL_ENDOWMENT
